...
%           cell indices.  A logical mask into the range 1:G.cells.num is
%           not supported.  Moreover, the cell indices must be unique
%           within the subset.  Repeated indices are not supported.
%
% RETURNS:
...
%           Specifically,
%
%              gcells(i) == global cell index (from 'G') of subG cell 'i'.
%              gfaces(i) == global face index (from 'G') of subG face 'i'.
%              gnodes(i) == global node index (from 'G') of subG node 'i'.
%
% NOTE.
