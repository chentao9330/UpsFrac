function [krw, Swco, pc, Swcr, pcinv, Swmax] = swfn(T, varargin)
% Construct water relperm evaluation functions from SWFN table.
%
% SYNOPSIS:
%   [krw, Swco, pc, Swcr] = swfn(table)
%
% PARAMETERS:
...
%
% SEE ALSO:
%   readRelPermTable, sgfn, swof, sgof, initBlackOilRelPerm.
